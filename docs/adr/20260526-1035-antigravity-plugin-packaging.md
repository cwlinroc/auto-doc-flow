...
**Correction note — 2026-05-27 (custom_notes):** Settings JSON files for commands and skills now support an optional `"custom_notes"` string array in addition to `name` and `description`. During the build, these entries are excluded from the YAML frontmatter and appended to the generated `SKILL.md` body as a `## Custom Notes` bulleted list. See [20260527-1633-packaging-time-agent-custom-notes.md](./20260527-1633-packaging-time-agent-custom-notes.md).
